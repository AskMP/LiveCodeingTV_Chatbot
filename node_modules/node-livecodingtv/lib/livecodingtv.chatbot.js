...
(function () {
    ...
    *   role(string who) = string of the viewer’s role ["owner"|"moderator"|"viewer"]
    ...
    var ChatBot = function (supplied_config) {
        ...
        this.role = function (who) {
            if (channel.owner === who) {
                ...
                return "moderator";
            } else if (channel.guests.indexOf(who) === 0) {
                // Could just check the who string for "guest__" but that would mean that forced guests by external scripts wouldn’t be correct
                return "guest";
            } else {
                return "viewer";
            }
